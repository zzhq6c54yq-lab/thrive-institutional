...
const WelcomeText: React.FC<WelcomeTextProps> = ({ userName }) => {
  ...
  return (
    <div className="text-center mt-8">
      <h1 className="text-4xl md:text-5xl font-bold tracking-tight space-y-3">
        ...
        <span className="block mt-2 text-transparent bg-clip-text bg-gradient-to-r from-[#E5C5A1] via-[#B87333] to-[#E5C5A1] animate-gradient-x" style={{backgroundSize: '200% auto', animationDelay: '0.5s'}}>
          Thrive MT
        </span>
      </h1>
      <p className="mt-4 text-xl text-transparent bg-clip-text bg-gradient-to-r from-[#E5C5A1]/90 to-[#B87333]/90">
