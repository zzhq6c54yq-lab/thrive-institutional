      ...
      <div className="container mx-auto max-w-6xl relative z-20">
        ...
        <div className="grid grid-cols-3 gap-8 relative z-10">
          ...
          >
            ...
            <span className="text-base font-bold text-black mb-1 relative z-10">Upgrade</span>
            <span className="text-base font-bold text-black relative z-10">Plan</span>
          </Button>
          ...
          >
            <span className="text-sm font-semibold mb-1 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">Omni Co-Pay</span>
            <span className="text-sm font-semibold bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">Credit</span>
          </Button>
        </div>
      </div>
    </div>
...
// NOTE: This is the canonical NewFeatures component for both dashboard and home.
